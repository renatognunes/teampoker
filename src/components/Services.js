...
import ServicesStyles from "../styles/ServicesPage.module.scss"
    ...
    <div className={ServicesStyles.wrapper}>
      <div id="live-poker" className={ServicesStyles.section}>
        ...
        <div className={ServicesStyles.text}>
          <p>
            Team Poker® has partnered with the most professional Live Poker Room
            software providers available. Their Poker Room Management and
            Tournament Software is available now to any large or small Casino
            and Poker Room. The poker software is the best in the World and can
            handle all aspects of poker room management for Cash and Tournament
            Poker Play.{" "}
          </p>
          <p>
            ...
            Satellites to Massively Large Tournaments with thousands of players.
            Our Partners offer Team Poker® limited licensing from FREE to
      ...
      >
        ...
        <div className={ServicesStyles.textLeft}>
          ...
          <p>
            ...
            The format mirrors the professional sports league model. Contact us
            about licensing.
          </p>
        </div>
        <div className={ServicesStyles.contact}>
      ...
      <div id="championship" className={ServicesStyles.section}>
        ...
        <div className={ServicesStyles.text}>
          <p>
            ...
            SERIES. This Series will be conducted by location: Home Games, City,
            State, Region, Country, Continent, and World Championship Finals for
            both Live and Online Poker Rooms.
          </p>
          <p>
            {" "}
            The WPTC Series will be designed to implement the Poker Sports Model
            for Poker Teams of Various Sizes, Classes, and Divisions all leading
            to The WORLD POKER TEAM CHAMPIONSHIP™ - Finals for Live and Online
            Poker. All Production and Video Licenses for Championship Licenses
            are issued separately. Contact Team Poker LLC for requirements and
            Licensing Partnerships for Team Poker® Championships.
          </p>
        </div>
        <div className={ServicesStyles.contact}>
          <Link to="/contact">
