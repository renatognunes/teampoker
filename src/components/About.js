...
import AboutStyles from "../styles/AboutPage.module.scss"
        ...
        <div className={AboutStyles.container}>
          ...
          >
            ...
            <p>
              ...
              pool. Any split is possible from 0-100%, either way.{" "}
              <span className={AboutStyles.bold}>
                The inverse of the individual finish positions determines the
                Global Points awarded for Team Point Scores that determine team
                finish positions and payouts.
              </span>
        ...
        >
          <div className={AboutStyles.details}>
            ...
            <p>
              ...
              preferred default method of seating is No-Contact, where teammates
              are not allowed together with opponents on the same table in
              tournaments. Teammates may play together or heads up during
              tournament table consolidation, but never on same table with
              opponents.{" "}
            </p>
            <p>
              ...
              collusion with Full-Contact as teammates are known and identified.
            </p>
            <p>
              {" "}
              <span className={AboutStyles.bold}>
        ...
        <div className={AboutStyles.container}>
          ...
          >
            ...
            <p>
              ...
              allows large{" "}
              <span className={AboutStyles.bold}>“CLASS TEAMS”</span> of varying
              size to compete as well in the same Tournament. Countries,
            ...
            <p>
              <span className={AboutStyles.bold}>
                ...
                in tournament poker and gaming events where Individuals, Teams,
                and Class Teams can handicap their skills (Reverse Handicap) and
